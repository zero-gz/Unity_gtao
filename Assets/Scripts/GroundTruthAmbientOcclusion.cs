...
//////C# To Shader Property
    ...
    [SerializeField]
    bool NoSpatioFilter = false;

    [SerializeField]
    bool NoTemporalFilter = false;
...
/* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* */
    ...
    private void UpdateVariable_SSAO()
    {
        ...
        if (!NoSpatioFilter)
            SpatialStep = (m_sampleStep / 6) % 4;

        if (!NoTemporalFilter)
            temporalStep = m_sampleStep % 6;

        float temporalRotation = m_temporalRotations[temporalStep];
        float temporalOffset = m_spatialOffsets[SpatialStep];
    ...
    private void RenderSSAO()
    {
        ...
        GTAOBuffer.CopyTexture(AO_BentNormal_RT[0], _CurrRT_ID);
        ...
        if (!NoSpatioFilter)
        {
            ...
            GTAOBuffer.CopyTexture(_GTAO_Spatial_Texture_ID, _CurrRT_ID);
        }
